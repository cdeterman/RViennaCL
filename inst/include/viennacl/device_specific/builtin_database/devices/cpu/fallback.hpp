...
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", reduction_template::parameters_type(1,128,128,FETCH_FROM_GLOBAL_CONTIGUOUS));
}
...
{
  db.add_4B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", row_wise_reduction_template::parameters_type(1,8,1,128,FETCH_FROM_GLOBAL_CONTIGUOUS));
}
...
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", vector_axpy_template::parameters_type(1,128,128,FETCH_FROM_GLOBAL_CONTIGUOUS));
}

inline void add_8B(database_type<reduction_template::parameters_type> & db)
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", reduction_template::parameters_type(1,128,128,FETCH_FROM_GLOBAL_CONTIGUOUS));
}
...
{
  db.add_8B(unknown_id, CL_DEVICE_TYPE_CPU, unknown, "", row_wise_reduction_template::parameters_type(1,8,1,128,FETCH_FROM_GLOBAL_CONTIGUOUS));
}
